...
type AddInvoiceClientProps = {
  onSelectInvoiceDate: (date?: Date) => void;
  onSelectInvoicePaymentDueDate: (date?: Date) => void;
};

function AddInvoiceClient({ onSelectInvoiceDate, onSelectInvoicePaymentDueDate }: AddInvoiceClientProps) {
  return (
    <div className="flex h-full gap-2 rounded-lg bg-white/[8%] px-5 py-5 max-md:flex-col max-md:px-5">
      ...
      <div className="flex w-full flex-col gap-2">
        <DatePicker onSelect={onSelectInvoiceDate} placeholder="Invoice date" />
